...
response = openai.ChatCompletion.create(
    model=model_name,
    messages=[
        {"role": "system", "content": "You are an investigator looking for code word for drugs hidden in sentences. Learn from the given examples and fill in the answer by replacing question marks in each of the numbered sentences. Answer in following format- Present: , Code word: , Code word meaning: "},
